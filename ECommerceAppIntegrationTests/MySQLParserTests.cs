...
namespace ECommerceApp.IntegrationTests
{
    ...
    public class MySQLParserTests
    {
        ...
        public async Task GetTable_AdminTableWithNoFilter_FullTable()
        {
            ...
            MySqlConnection connection = await connector.CreateConnection();

            // Act
            var parser = new MySQLParser(connection, SqlTable.AdminInfo);
        ...
        public async Task GetTable_UserTableWithNoFilter_FullTable()
        {
            ...
            // Act
            var parser = new MySQLParser(connection, SqlTable.UserInfo);
            DataTable dt = await parser.GetTable();
